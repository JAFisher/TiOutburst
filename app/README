...
Objects Constructs
------------------
<Utterance> : Utterance is what you want to be said in an paragraph, it
is configurable to the following parameters.
...
Events
------
    @talk : Expects Array<Utterance>
    utter.talk([<Utterance>]);
    ...
    @showAvailableLanguages: @returns Array of language Codes available to use with utterance.
...
<Utterance:beforeDelay>
<Utterance:afterDelay>
